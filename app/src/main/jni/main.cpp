    ...
    // if (a1 == 0x1d) { // hardcoded arg pattern
        ...
        for (int i = 0x0; i < 0x20; ++i) {
            if (*(char *)(a2 + i) == 0x51 && *(char *)(a2 + i + 1) == 0x08) {
                ...
                __android_log_print(6, "pmmtool", "[1] old PMm: %s", pmm_str);
                ...
                for (int j = 0; j < 8; ++j)
                    sprintf(pmm_str + j * 3, "%02x ", *(char *)(a2 + i + 2 + j));
                __android_log_print(6, "pmmtool", "[1] new PMm: %s", pmm_str);
            }
        }
        ...
        for (int i = 0x0; i < 0x20; ++i) {
            if (*(char *)(a2 + i) == 0xff && *(char *)(a2 + i + 1) == 0xff
                ...
                __android_log_print(6, "pmmtool", "[2] old PMm: %s", pmm_str);
                ...
                for (int j = 0; j < 8; ++j)
                    sprintf(pmm_str + j * 3, "%02x ", *(char *)(a2 + i + j));
                __android_log_print(6, "pmmtool", "[2] new PMm: %s", pmm_str);
            }
        }
    //}
